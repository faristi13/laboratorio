...
var simulacion= require('./sensors/weatherStation');
...
const topic = '/ul/4jggokgpepnvsb2uv4s40d59op/weatherStation001/attrs'
client.on('connect', () => {
...
*/
    ...
    dato=simulacion()
    datosEnviar="temperature|"+dato.temperature+"|relativeHumidity|"+dato.relativeHumidity+
