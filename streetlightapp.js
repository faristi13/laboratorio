...
var simulacion= require('./sensors/streetligth');
...
const topic = '/ul/4jggokgpepnvsb2uv4s40d59ov/streetLight001/attrs'
client.on('connect', () => {
...
*/
    ...
    dato=simulacion()
    datosEnviar="luminaireSupplyVoltage|"+dato.luminaireSupplyVoltage+"|powerSupplyCurrent|"+dato.powerSupplyCurrent+
